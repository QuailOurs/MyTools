...
public class Consumer08DemoThread1 {
	...
	static final Logger log = LoggerFactory.getLogger(Consumer08DemoThread1.class);
	...
	static {
		...
		topic = topicMap.get(1);
	}

	final String _name;

	public static void main(String[] args) throws Exception {
		Consumer08DemoThread1 consumerDemo = new Consumer08DemoThread1("consumer-demo");
	...
	public Consumer08DemoThread1(String name) {
		this._name = name;
		// common config
